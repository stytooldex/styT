...
public class Defaults {
    ...
    static int dataChunkSize = 65536;  // do file I/O in 64k chunks
    ...
    private static int consoleLogLevel = Log.INFO;
    private static String settingsName = "SwiFTP";
    //protected static String username = "user";
    //protected static String password = "";
    static int portNumber = 2121;
    //	protected static int ipRetrievalAttempts = 5;
    static final int tcpConnectionBacklog = 5;
    static final String chrootDir = nico.styTool.Util.getSdDirectory();
    ...
    static final int REMOTE_PROXY_PORT = 2222;
    static final String STRING_ENCODING = "UTF-8";
    static final int SO_TIMEOUT_MS = 30000; // socket timeout millis
    ...
    static final String SESSION_ENCODING = "UTF-8";
    ...
    static final boolean do_mediascanner_notify = true;
...
//	}
    ...
    private static int settingsMode = Context.MODE_WORLD_WRITEABLE;

    static int getUiLogLevel() {
        return uiLogLevel;
    }
    ...
    static int getServerLogScrollBack() {
