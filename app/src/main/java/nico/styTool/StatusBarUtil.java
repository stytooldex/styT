...
public class StatusBarUtil {
    ...
    public static void setColorForSwipeBack0(Activity activity, int color) {
     ...
     * @param statusBarAlpha 状态栏透明度
     */
    static void setTranslucent(Activity activity, @IntRange(from = 0, to = 255) int statusBarAlpha) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
